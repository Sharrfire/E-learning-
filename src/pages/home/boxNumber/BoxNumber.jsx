        ...
        <div className={cx("boxNumberContainer")}>
            <div className={cx("row")}>
                <div className={cx("col","l-3","m-6","p-4")}>
                    <div className={cx("boxNumber")}>
                        ...
                        <div className={cx("textNumber")}>
                            <span>{counterOn&&(<CountUp start={0} end={9758} duration={1.5} delay={0}/>)}</span>
                        </div>
                ...
                <div className={cx("boxNumber")}>
                        ...
                        <div className={cx("textNumber")}>
                            <span>{counterOn&&(<CountUp start={0} end={700} duration={1.5} delay={0}/>)}</span>
                        </div>
                ...
                <div className={cx("boxNumber")}>
                        ...
                        <div className={cx("textNumber")}>
                            <span>{counterOn&&(<CountUp start={0} end={27580} duration={1.5} delay={0}/>)}</span>
                        </div>
                ...
                <div className={cx("boxNumber")}>
                        ...
                        <div className={cx("textNumber")}>
                            <span>{counterOn&&(<CountUp start={0} end={200} duration={1.5} delay={0}/>)}</span>
                        </div>
